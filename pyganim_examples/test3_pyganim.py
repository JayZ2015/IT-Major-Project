...
image = pygame.image.load("testimages/hero1.jpg").convert()
image2=pygame.image.load('testimages/hero2.jpg').convert()
    
alAnim = pyganim.PygAnimation([(image, 0.5),
                               (image2, 0.5)])
alAnim.set_colorkey((0,0,0))
alAnim.set_alpha(50)
alAnim.scale((100, 100))
alAnim.play()
